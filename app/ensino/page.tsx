...
import { Check, BookOpen, Users, BarChart, Shield, Zap, ArrowRight, GraduationCap, School, MessageCircle } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 bg-card/80 backdrop-blur-sm hover:shadow-lg transition-all">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                  <BarChart className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-heading text-lg mb-2 primary-text">Monetização Inteligente</h3>
                <p className="text-muted-foreground text-sm">
                  Venda flashcards oficiais como material de estudo complementar
                </p>
              </Card>
              ...
              <Card className="p-6 bg-card/80 backdrop-blur-sm hover:shadow-lg transition-all">
                ...
                <h3 className="font-heading text-lg mb-2 primary-text">Controle Total</h3>
                <p className="text-muted-foreground text-sm">
                  Você define preços, promoções e condições de acesso
                </p>
              </Card>
              ...
              <Card className="p-6 bg-card/80 backdrop-blur-sm hover:shadow-lg transition-all">
                ...
                <h3 className="font-heading text-lg mb-2 primary-text">Valor Agregado</h3>
                <p className="text-muted-foreground text-sm">
                  Fortaleça sua marca oferecendo material de estudo de alta qualidade
                </p>
              </Card>
            </div>
          </div>
