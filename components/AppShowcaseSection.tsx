...
// Static data extracted (computed once at build time)
const features = [
  {
    icon: CheckCircle,
    ...
    keywords: "flashcards diretos, perguntas objetivas, memória eficiente",
  },
  {
    icon: Zap,
    title: "Feedback imediato",
    description: "Veja imediatamente a resposta e marque se acertou ou errou.",
    keywords: "feedback instantâneo, aprendizado rápido, resposta imediata",
  },
  {
    icon: Brain,
    ...
    keywords: "algoritmo IA, revisão personalizada, estudo adaptativo",
  },
  {
    icon: Target,
    title: "Foco no que importa",
    description: "O que você erra, aparece mais; o que você já domina, aparece menos. Simples, eficiente e no seu ritmo!",
    keywords: "aprendizado adaptativo, revisão inteligente, estudo personalizado",
  },
] as const;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div 
              className="space-y-8"
              role="list"
              aria-label="Recursos principais do aplicativo"
            >
              {features.slice(0, 2).map((feature, index) => {
                ...
                return (
                  <article
                    key={feature.title}
                    className="p-6 bg-card/50 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:scale-105 animate-slide-up rounded-lg"
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 
                          className="font-heading text-xl mb-2 text-foreground font-semibold"
                          itemProp="name"
                        >
                          {feature.title}
                        </h3>
            ...
            <div className="flex flex-col items-center justify-center lg:px-8 space-y-8">
              <figure 
                className="relative animate-fade-in max-w-sm w-full" 
              ...
              >
                ...
                >
                  ...
                  <a href="https://apps.apple.com/br/app/sappie-flashcards-digitais/id6737522389">
                    Baixe o aplicativo Sappie
                  </a>
                </video>
                
                <figcaption className="sr-only">
                  Vídeo demonstrativo do aplicativo Sappie mostrando flashcards inteligentes em uso
                </figcaption>
                
                {/* Glow effect */}
                <div className="absolute inset-0 bg-primary/10 rounded-2xl blur-2xl -z-10" aria-hidden="true" />
                
                <meta itemProp="contentUrl" content="/site/videos/sappie-video-app.webm" />
                <meta itemProp="description" content="Demonstração do aplicativo Sappie" />
              </figure>
            ...
            <div 
              className="space-y-8"
              role="list"
              aria-label="Recursos adicionais do aplicativo"
            >
        ...
        <div className="sr-only">
          <div itemScope itemType="https://schema.org/MobileApplication">
            ...
            <meta itemProp="operatingSystem" content="iOS 13.0 ou posterior, Android 8.0 ou posterior" />
            ...
            <meta itemProp="fileSize" content="45MB" />
          </div>
        </div>
      </div>
    </section>
